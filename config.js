module.exports = {
  ...
  NEXT_SCHEDULE_POLL: process.env.NEXT_SCHEDULE_POLL || 300_000, // default to 300 seconds
  MAX_NUMBER_OF_POLL: process.env.MAX_NUMBER_OF_POLL || 8640, // number of polls before stopping
